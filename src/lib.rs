...
#[derive(Debug)]
pub struct 3BoxProfileProcessor {
    verbose: bool,
    processed_count: usize,
}

impl 3BoxProfileProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting 3BoxProfile processing");
    
    let mut processor = 3BoxProfileProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = 3BoxProfileProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = 3BoxProfileProcessor::new(false);
